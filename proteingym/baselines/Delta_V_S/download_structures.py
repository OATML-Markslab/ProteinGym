...
import argparse
_p = argparse.ArgumentParser(description="Download AlphaFold structures for ProteinGym proteins")
_p.add_argument("--DMS_reference_file_path", required=True, help="DMS_substitutions.csv")
_p.add_argument("--pdb_cache", default="pdb_cache", help="Folder for downloaded PDBs")
_a = _p.parse_args()
